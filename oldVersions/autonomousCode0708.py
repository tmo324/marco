...
def makeAndSendString(): 
    ...
    strMessage=str(latitude) + "," + str(longitude) + "," + str(utctime) + "," + str(pointing) + "," + str(shouldPoint) + "," + str(whatToDo) + "," + str(distance)+","+str(timesDone) + "," + str(ina.voltage()) + "," + str(goingToLocation) +"," + str(printedCount) +"," + str(piTemp)
